...
4. **Re-sync second-agent mirrors.** The updater does not know about Codex mirrors. After adopting hook changes, copy the `.claude/hooks/` versions into `.codex/hooks/` and keep them byte-identical.
